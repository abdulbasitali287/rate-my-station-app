            ...
            <div class="col-md-3 pb-4">
                <div style="width: 100%;height: 100%;display: flex;flex-direction: column;justify-content: center;">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="#" class="fw-bold bg-transparent" style="margin-block: 6px;border: 2px solid #194D79;color: #194D79;padding-block: 11px;border-radius: 12px;letter-spacing: 0.5px;transition: all 0.5s;text-align: center;padding-inline: 12px;margin-inline-end: 10px;">
                            <span class="d-inline-block" style="background-color: #194D79;width: 22px;height: 22px;border-radius: 100%;">
                            <img src="{{ asset('user/assets/vectors/chat-blue-icon.png') }}" style="margin-top: -5px;margin-left: 1px;" alt=""></span>
                        </a>
                        <a href="#" class="fw-bold bg-transparent flex-grow-1" style="margin-block: 6px;border: 2px solid #194D79;color: #194D79;padding-block: 11px;border-radius: 12px;letter-spacing: 0.5px;transition: all 0.5s;text-align: center;">
                            Contact Info
                        </a>
            ...
            <div class="col-md-8 pt-5">
                ...
                <div class="bg-white p-5 mt-4" style="padding: 20px;border-radius: 10px;box-shadow: 0px 2px 15px rgba(0, 0, 0, 0.1);">
                    <div class="row align-items-center pb-4">
                        <div class="col-12">
                            <h2 class="fw-bold" style="font-size: 24px;">News Dirctors</h2>
                        </div>
                    </div>
