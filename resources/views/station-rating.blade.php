            ...
            <div class="col-md-3">
                <div style="width: 100%;height: 100%;display: flex;flex-direction: column;justify-content: center;">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <button class="fw-bold bg-transparent" style="padding-inline: 70px;padding-block: 11px;border-radius: 12px;letter-spacing: 0.5px;transition: all 0.5s;border:2px solid #194D79;color: #194D79;">Job Openings</button>
                        <img src="{{ asset('user/assets/vectors/v-flag-station-rating.png') }}" style="width: 15px;height: 20px;" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col col-md-8 px-0">
                ...
                <div class="bg-white mt-4" style="padding: 20px;border-radius: 10px;box-shadow: 0px 2px 15px rgba(0, 0, 0, 0.1);">
                    ...
                    <div class="d-flex justify-content-between p-4 mb-4">
                        ...
                        <div class="d-flex align-items-center">
                            <div>
                                <a href="#" class="subscribe-btn px-5 fw-bold me-3" style="background-color: transparent;border: 2px solid #194D79;color: #194D79;">Contact Info</a>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between p-4 mb-4">
...
<section>
    {{-- shop container --}}
    <div id="shop-container" class="container pb-5" style="border-bottom: 1px solid #BDBDBD;">
        ...
        <div class="row">
            ...
            <x-user.product-card visibility="visible" image="user/assets/img/image-6.png" title="America Needs Local News Bar Chain Bracelet" amount="30.50 – $33.50" />

            <x-user.product-card visibility="visible" image="user/assets/img/image-7.png" title="America Needs Local News Mug" amount="11.00 – $15.50" />
