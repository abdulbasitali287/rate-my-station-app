    ...
    <div class="container py-4">
        <div class="row overflow-hidden" style="border-radius: 10px;box-shadow: 0 2px 15px rgba(0, 0, 0, 0.1);">
            ...
            <div class="col-md-6 bg-white px-5 d-flex flex-column justify-content-between pt-4 pb-5">
                <div>
                    <div class="row text-center">
                        <div class="col-6 py-4 px-0">
                            <a href="{{ url('employee-login') }}" class="fw-light pb-3" style="color: #828282;font-size: 24px;" id="employee-tab">Employee</a>
                        </div>
                        <div class="col-6 py-4 px-0">
                            <a href="{{ url('newsroom-login') }}" class="fw-bold active" style="color: #89C400;font-size: 24px;" id="newsroom-tab">Newsroom</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 px-0">
                            <form action="#">
                                ...
                                <x-user.form-group label="Station’s name" placeholder="Type your usename here..."/>
                ...
                <div class="d-flex">
                    <p class="fw-light pe-1">Don’t have any account? </p><a href="{{ url('newsroom-register') }}" class="fw-bold" style="color: #89C400;border-bottom: 2px solid #89C400;"> Register here</a>
                </div>
            </div>
        </div>
    </div>
