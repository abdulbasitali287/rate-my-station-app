                ...
                <div class="row overflow-hidden custom-card">
                    ...
                    <div class="col-md-6 bg-white px-5 d-flex flex-column justify-content-between pt-4 pb-5">
                        <div>
                            <div class="row text-center">
                                <div class="col-6 py-4 px-0">
                                    <a href="{{ url('employee-login') }}" class="fw-bold pb-3 active employee-tab">Employee</a>
                                </div>
                                <div class="col-6 py-4 px-0">
                                    <a href="{{ url('newsroom-login') }}" class="fw-light newsroom-tab">Newsroom</a>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="{{ url('employee-register') }}" class="fw-bold register-link">Register here</a>
                        </div>
                    </div>
                </div>
            </div>
