        ...
        <div class="container">
            <div class="d-flex py-4">
                ...
                <ul class="d-flex justify-content-around align-items-center flex-grow-1">
                    <li>
                        <a href="#" style="font-weight: normal;color: #828282;">T-shirt</a>
                    </li>
                    <li>
                        <a href="#" style="font-weight: normal;color: #828282;">Hoodie/Sweater</a>
                    </li>
                    <li>
                        <a href="#" style="font-weight: normal;color: #828282;">Hat</a>
                    </li>
                    <li>
                        <a href="#" style="font-weight: normal;color: #828282;">Baby</a>
                    </li>
                    <li>
                        <a href="#" style="font-weight: normal;color: #828282;">Accesories</a>
                    </li>
                    <li>
                        <a href="#" style="font-weight: normal;color: #828282;">Poster</a>
                    </li>
                    <li>
                        <a href="#" style="font-weight: normal;color: #828282;">Sticker</a>
                    </li>
                    <li>
                        <a href="#" style="font-weight: normal;color: #828282;">Bag</a>
                    </li>
                    <li>
                        <a href="#" style="font-weight: normal;color: #828282;">Mug</a>
                    </li>
                </ul>
            </div>
        </div>
