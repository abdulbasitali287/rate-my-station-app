...
<aside style="min-height: 650px;">
    ...
    <ul class="">
        <li class="py-4 {{ Request::is('user-profile') ? 'active' : '' }}">
            <a href="{{ url('user-profile') }}" class="fw-medium text-black px-4" style="font-size: 20px;">
        ...
        <li class="py-4 {{ Request::is('user-contact-info') ? 'active' : '' }}">
            <a href="{{ url('user-contact-info') }}" class="fw-medium text-black px-4" style="font-size: 20px;">
        ...
        <li class="py-4 {{ Request::is('user-subscription') ? 'active' : '' }}">
            <a href="{{ url('user-subscription') }}" class="fw-medium text-black px-4" style="font-size: 20px;">
        ...
        <li class="py-4 {{ Request::is('user-verification') ? 'active' : '' }}">
            <a href="{{ url('user-verification') }}" class="fw-medium text-black px-4" style="font-size: 20px;">
