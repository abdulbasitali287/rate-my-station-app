...
<aside style="min-height: 650px;">
    ...
    <ul class="">
        <li class="py-4 {{ Request::is('account-settings-user-profile') ? 'active' : '' }}">
            <a href="{{ url('account-settings-user-profile') }}" class="fw-medium text-black px-4" style="font-size: 20px;">
        ...
        <li class="py-4 {{ Request::is('account-settings-user-contact-info') ? 'active' : '' }}">
            <a href="{{ url('account-settings-user-contact-info') }}" class="fw-medium text-black px-4" style="font-size: 20px;">
        ...
        <li class="py-4 {{ Request::is('account-settings-user-subscription') ? 'active' : '' }}">
            <a href="{{ url('account-settings-user-subscription') }}" class="fw-medium text-black px-4" style="font-size: 20px;">
        ...
        <li class="py-4 {{ Request::is('account-settings-user-verification') ? 'active' : '' }}">
            <a href="{{ url('account-settings-user-verification') }}" class="fw-medium text-black px-4" style="font-size: 20px;">
        ...
        <li class="py-4 {{ Request::is('user-change-password') ? 'active' : '' }}">
            <a href="{{ url('user-change-password') }}" class="fw-medium text-black px-4" style="font-size: 20px;">
